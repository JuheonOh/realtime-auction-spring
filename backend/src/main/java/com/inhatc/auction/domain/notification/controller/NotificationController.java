...
public class NotificationController {
    ...
    public SseEmitter getNotificationStream(@NonNull HttpServletRequest request,
    ...
    public ResponseEntity<?> patchNotificationAll(@NonNull HttpServletRequest request) {
        notificationService.markAsReadAll(request);
        return ResponseEntity.ok().build();
    }

    @PatchMapping("/users/notifications")
    public ResponseEntity<?> patchNotification(@NonNull HttpServletRequest request,
            @RequestBody @NonNull NotificationRequestDTO notificationRequestDTO) {
        notificationService.markAsRead(request, notificationRequestDTO.getNotificationId());
        return ResponseEntity.ok().build();
    }

    @DeleteMapping("/users/notifications/all")
    public ResponseEntity<?> deleteNotificationAll(@NonNull HttpServletRequest request) {
        notificationService.deleteNotificationAll(request);
        return ResponseEntity.ok().build();
    }

    @DeleteMapping("/users/notifications")
    public ResponseEntity<?> deleteNotification(@NonNull HttpServletRequest request,
            @RequestBody @NonNull NotificationRequestDTO notificationRequestDTO) {
